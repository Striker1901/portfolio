/* Lenis 1.3.8 — https://github.com/darkroomengineering/lenis, licença MIT.
   Biblioteca externa, auto-alojada (ver assets/js/vendor/), minificada tal como
   distribuída — não editada à mão, por isso sem comentários WHAT/TERM/WHY linha a linha
   (esses vivem em main.js, onde este ficheiro é USADO, não aqui onde é só guardado).
   Motivo de estar aqui: Ronda 10 (19-08-2026), pedido do Francisco para o scroll do site
   ficar mais suave/gradual — a mesma biblioteca que o mapo.studio (referência já clonada
   nesta ronda 6) usa para o mesmo efeito. */
